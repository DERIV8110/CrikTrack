...
def load_scoreboard():
        ...
        # Column config
        score_page.grid_columnconfigure(0, weight=2)
        score_page.grid_columnconfigure(1, weight=2)
        score_page.grid_columnconfigure(2, weight=2)
        score_page.grid_columnconfigure(3, weight=2)
        score_page.grid_columnconfigure(4, weight=2)
        ...
        ##score_page = customtkinter.CTkToplevel(home)
        #score_page.geometry("1360x768")
        #
        #frame5 = ttk.Frame(score_page)
        #frame5.grid(row=1, column=0, columnspan=6, sticky="nsew", padx=10, pady=10)
        #score_page.grid_rowconfigure(0, weight=1)
        #score_page.grid_rowconfigure(1, weight=1)
        #score_page.grid_rowconfigure(2, weight=1)
        #score_page.grid_rowconfigure(3, weight=1)
        #score_page.grid_rowconfigure(4, weight=1)
        ...
        #
        #teama_label = customtkinter.CTkLabel(score_page,text=players_entry.get())
        #teama_label.grid(       row=0,column=0)
        #versus_label = customtkinter.CTkLabel(score_page,text="VS")
        #versus_label.grid(      row=0,column=1)
        #teamb_label = customtkinter.CTkLabel(score_page,text=players_entry2.get())
        #teamb_label.grid(       row=0,column=2)
        #teama_toss_label = customtkinter.CTkLabel(score_page,text=players_entry.get())
        #teama_toss_label.grid(  row=0,column=3)
        #toss_win_label = customtkinter.CTkLabel(score_page,text="Chose to bat")
        #toss_win_label.grid(    row=0,column=4)
        #tree1 = ttk.Treeview(frame5, columns=("Team","Player","Runs","Balls","1","2","3","4","5","6","Foul","How Out?"),show = "headings")
        #tree1.heading("Team"        ,   text="Team"    )
        #tree1.heading("Player"      ,   text="Player"  )
        #tree1.heading("Runs"        ,   text="Runs"    )
        #tree1.heading("Balls"       ,   text="Balls"   )
        ...
        #tree1.heading("Foul"        ,   text="Foul"    )
        #tree1.heading("How Out?"    ,   text="How Out?")
        #tree1.column("Team"         , width=150)
        #tree1.column("Player"       , width=60 )
        #tree1.column("Runs"         , width=60 )
        #tree1.column("Balls"        , width=60 )
        #tree1.column("1"            , width=60 )
        #tree1.column("2"            , width=60 )
        #tree1.column("3"            , width=60 )
        #tree1.column("4"            , width=60 )
        #tree1.column("5"            , width=60 )
        #tree1.column("6"            , width=60 )
        #tree1.column("Foul"         , width=60 )
        #tree1.column("How Out?"     , width=80 )
        #tree1.grid(row=1,column=0,columnspan=5)
        #conn = sqlite3.connect('batsman.db')
        #c = conn.cursor()
        #c.execute('SELECT TEAM,NAME,RUNS,BALLS,ONES,TWOS,THREES,FOURS,FIVES,SIXES,FOWL,HOWOUT FROM BATSMAN')
        #result3 = c.fetchall()
